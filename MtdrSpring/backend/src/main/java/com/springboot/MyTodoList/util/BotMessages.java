...
public enum BotMessages {
    ...
    CODE_REVIEW("Starting code review: "),
    ...
    ITEM_UNDONE("Item marked as undone! Write /start to go to the main screen."),
    ITEM_DELETED("Item deleted! Write /start to go to the main screen."),
